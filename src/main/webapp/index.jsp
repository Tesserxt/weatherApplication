...
body {
  ...
  background: url('https://images.unsplash.com/photo-1488866022504-f2584929ca5f?auto=format&fit=crop&w=1486&q=80&ixid=dW5zcGxhc2guY29tOzs7Ozs%3D') no-repeat center center fixed;
}
...
.mainContainer {
  ...
  border-radius: 1rem;
  background: #fff;
  box-shadow: 0 14px 28px rgba(220, 220,230,0.25), 
			0 10px 10px rgba(240,230,220,0.22);
}
